        ...
        <div className="flex flex-col items-center justify-between gap-10 md:flex-row md:gap-12">
          <div className="max-w-lg text-center md:text-left">
            <h2 className="mb-4 text-3xl md:text-4xl font-bold leading-tight">
              Få Axie Studio <span className="text-yellow-300">direkt på din enhet</span>
            </h2>
            <p className="mb-6 md:mb-8 text-base md:text-lg text-white/90 max-w-md mx-auto md:mx-0">
              Installera vår app för snabbare åtkomst, offline-funktionalitet och en smidigare upplevelse. Inga
              nedladdningar från app-butiker behövs!
            </p>
            ...
            {canInstall && (
              ...
              >
                ...
                <span className="relative z-10">Installera Axie Studio</span>
              </button>
            )}
            ...
            {!canInstall && (
              ...
              >
                ...
                <span className="relative z-10">Visa installationsguide</span>
              </button>
            )}
          </div>
          ...
          <div className="w-full max-w-sm overflow-hidden rounded-2xl bg-white shadow-2xl">
            <div className="bg-gradient-to-r from-blue-600 to-blue-500 p-5 text-white">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold">Installera Axie Studio</h3>
                <button
