...
export function ModernHeader() {
  ...
  const navLinks = [
    { name: "Funktioner", href: "#features", id: "features", icon: <LayoutDashboard className="h-4 w-4" /> },
    { name: "Priser", href: "#pricing", id: "pricing", icon: <CreditCard className="h-4 w-4" /> },
    { name: "Kontakt", href: "#contact", id: "contact", icon: <Mail className="h-4 w-4" /> },
  ]

  const quickLinks = [
    {
      name: "Bokningsfunktioner",
      href: "#booking-features",
      icon: <Calendar className="h-4 w-4" />,
      description: "Smidiga bokningar online för dina kunder",
    },
    {
      name: "Adminfunktioner",
      href: "#admin-features",
      icon: <LayoutDashboard className="h-4 w-4" />,
      description: "Kraftfulla verktyg för att hantera din verksamhet",
    },
    {
      name: "Klientfunktioner",
      href: "#client-features",
      icon: <Users className="h-4 w-4" />,
      description: "Förbättra kundupplevelsen med smarta funktioner",
    },
    {
      name: "Mobilappar",
      href: "#mobile-apps",
      icon: <Smartphone className="h-4 w-4" />,
      description: "Tillgång till ditt system var som helst",
    },
  ]
                  ...
                  <div className="flex-1 overflow-auto py-6 px-4">
                    ...
                    <div className="mb-6 bg-blue-50 rounded-lg p-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-medium text-blue-700">Nytt i Axie Studio</h3>
                      </div>
                      <p className="text-sm text-gray-600 mb-2">
                        Vi har uppdaterat vår bokningsmotor för ännu snabbare prestanda!
                      </p>
                      <Link
                        href="#whats-new"
                    ...
                    <nav className="space-y-1 mb-6">
                      <h3 className="font-medium text-sm text-gray-500 px-2 mb-2">Huvudmeny</h3>
                      {navLinks.map((link) => (
                        <Link
                          key={link.href}
                          href={link.href}
                    ...
                    {/* Quick Links */}
                    <div className="mb-6">
                      <h3 className="font-medium text-sm text-gray-500 px-2 mb-2">Snabblänkar</h3>
                    ...
                    <div className="border-t pt-4 mb-6">
                      <h3 className="font-medium text-sm text-gray-500 px-2 mb-2">Kontakta oss</h3>
                      <div className="space-y-2">
