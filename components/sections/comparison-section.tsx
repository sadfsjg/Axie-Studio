...
export function ComparisonSection({ columnHeaders, features, onCtaClick }: ComparisonSectionProps) {
  ...
  return (
    ...
    >
      <SectionSEO
        title="Jämförelse av bokningssystemtyper | Axie Studio"
        description="Hitta den perfekta lösningen för din verksamhet genom att jämföra olika typer av bokningssystem och deras funktioner."
        slug="comparison"
        type="Table"
      />
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
          ...
          <AnimatedText
            as="h2"
            text="Jämförelse av bokningssystemtyper"
          ...
          >
            Hitta den perfekta lösningen för din verksamhet
          </motion.p>
        </div>
        ...
        >
          <Table>
            <TableHeader className="bg-gray-50 dark:bg-gray-900/50">
              <TableRow>
                <TableHead className="w-[200px] font-bold">Funktion</TableHead>
        ...
        <motion.div variants={fadeIn("up", 0.5)} className="flex justify-center mt-12">
          <Button
            ...
            onClick={onCtaClick}
          >
            <span className="text-base">Hitta rätt lösning för dig</span>
