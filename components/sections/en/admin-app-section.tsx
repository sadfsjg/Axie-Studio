...
export function AdminAppSectionEn() {
  return (
    <section id="admin-app" className="relative py-20 overflow-hidden bg-gradient-to-b from-slate-100 to-white">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Powerful Admin Application</h2>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            A powerful admin application that gives you full control over your business. Manage bookings, customers, and
            schedules directly from your mobile or computer.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideInFromLeft}>
            <h3 className="text-2xl font-bold text-slate-900 mb-6">Everything You Need to Manage Your Business</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <Card className="border border-slate-200">
                <CardContent className="p-4 flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-900 mb-1">Manage Bookings</h4>
                    <p className="text-sm text-slate-600">Accept, reject, or modify bookings with a single click</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border border-slate-200">
                <CardContent className="p-4 flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-900 mb-1">Real-time Notifications</h4>
                    <p className="text-sm text-slate-600">Get instant notifications when new bookings arrive</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border border-slate-200">
                <CardContent className="p-4 flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-900 mb-1">Block Time Slots</h4>
                    <p className="text-sm text-slate-600">Mark times as unavailable in your calendar</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border border-slate-200">
                <CardContent className="p-4 flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-900 mb-1">Customer Management</h4>
                    <p className="text-sm text-slate-600">View customer history and manage relationships</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border border-slate-200">
                <CardContent className="p-4 flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-900 mb-1">Statistics & Reports</h4>
                    <p className="text-sm text-slate-600">Gain insights into your business with detailed reports</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border border-slate-200">
                <CardContent className="p-4 flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-900 mb-1">Custom Settings</h4>
                    <p className="text-sm text-slate-600">Configure the app according to your specific needs</p>
                  </div>
                </CardContent>
              </Card>
            </div>
              ...
              <div className="relative z-10 overflow-hidden rounded-[32px] border-8 border-gray-800 bg-gray-800 shadow-xl">
                ...
                <div className="relative pt-6 h-[600px] bg-slate-100 overflow-hidden">
                  ...
                  <div className="bg-blue-600 text-white p-4 pt-8">
                    ...
                    <p className="text-blue-100 text-sm">Tuesday, May 9, 2023</p>
                  </div>
                  ...
                  <div className="absolute top-24 right-4 z-30 bg-white rounded-lg shadow-lg p-3 max-w-[250px] border border-slate-200 animate-pulse">
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-sm">New booking!</h4>
                        <p className="text-xs text-slate-600">John Smith has booked a time at 2:30 PM</p>
                      </div>
                    </div>
                  ...
                  <div className="h-full pt-4 overflow-y-auto">
                    <div className="px-4 mb-6">
                      <h4 className="font-medium text-slate-900 mb-3">Today's Bookings</h4>
                        ...
                        <div className="bg-white p-3 rounded-lg border border-slate-200">
                          <div className="flex justify-between items-start">
                            <div>
                              ...
                              <h5 className="font-medium">Mary Johnson</h5>
                              <p className="text-xs text-slate-500">Haircut & Color</p>
                            </div>
                            <div className="flex space-x-1">
                        ...
                        <div className="bg-white p-3 rounded-lg border border-slate-200">
                          <div className="flex justify-between items-start">
                            <div>
                              ...
                              <h5 className="font-medium">James Wilson</h5>
                              <p className="text-xs text-slate-500">Men's Haircut</p>
                            </div>
                            <div className="flex space-x-1">
                              <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-slate-500">
                                <MessageSquare className="h-4 w-4" />
                          ...
                          <div className="mt-2 flex items-center">
                            <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800">
                              <Clock className="h-3 w-3 mr-1" /> Awaiting confirmation
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="bg-white p-3 rounded-lg border border-slate-200">
                          <div className="flex justify-between items-start">
                            <div>
                              ...
                              <p className="text-xs text-slate-500">Beard & Haircut</p>
                            </div>
                            <div className="flex space-x-1">
                              <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-slate-500">
                                <MessageSquare className="h-4 w-4" />
                          ...
                          <div className="mt-2 flex items-center">
                            <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-amber-100 text-amber-800">
                              <Bell className="h-3 w-3 mr-1" /> New booking
                            </span>
                          </div>
                        </div>
                      </div>
