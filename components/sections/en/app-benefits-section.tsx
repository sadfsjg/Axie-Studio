...
export function AppBenefitsSectionEn({ onDemoClick }: AppBenefitsSectionProps) {
  ...
  const benefits = [
    {
      ...
      description:
        "Give your customers a professional booking experience with an app in your brand. The app can be customized with your colors, logo, and corporate identity to create a seamless brand experience.",
    },
    {
      icon: <Calendar className="h-5 w-5" />,
      title: "Calendar Synchronization",
      description:
        "Synchronize bookings with your Google, Outlook, or Apple calendar automatically. All changes are updated in real-time so you never miss a booking or risk double bookings.",
    },
    {
      icon: <Bell className="h-5 w-5" />,
      title: "Automatic Reminders",
      description:
        "Reduce the number of missed bookings with automatic SMS and email reminders. You can customize when and how reminders are sent to maximize attendance at booked times.",
    },
    {
      icon: <BarChart className="h-5 w-5" />,
      title: "Detailed Statistics",
      description:
        "Gain insight into your business with real-time reports and booking statistics. Analyze trends, discover popular times, and optimize your schedule based on actual data.",
    },
    {
      icon: <Users className="h-5 w-5" />,
      title: "Customer Management",
      description:
        "Build a customer database with booking history and preferences. Improve customer relationships by saving important information and offering personalized service based on previous interactions.",
    },
    {
      icon: <MessageCircle className="h-5 w-5" />,
      title: "Integrated Communication",
      description:
        "Communicate with customers directly in the app via SMS, email, or chat messages. Keep all communication in one place for easy follow-up and better customer service.",
    },
  ]
    ...
    <SectionBackground id="app-benefits" className="bg-gradient-to-b from-white to-slate-50">
      <div className="text-center mb-16">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
        >
          Booking System for Web and Mobile
        </motion.h2>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-6 relative overflow-hidden max-w-md mx-auto lg:ml-auto lg:mr-0">
            ...
            >
              <Image
                ...
                alt="Booking system app on mobile devices"
                width={500}
                height={500}
