...
import { BookingIframe } from "@/components/en/booking-iframe"
import { fadeIn } from "@/lib/animation"

export function BookingSectionEn() {
  return (
    <section id="booking" className="relative py-20 overflow-hidden bg-gradient-to-b from-white to-blue-50">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Book a Demo</h2>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Schedule a time to see how our booking system can help your business. We'll show you how to streamline your
