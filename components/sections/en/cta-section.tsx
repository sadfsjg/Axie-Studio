...
export function CtaSectionEn({ onDemoClick }: CtaSectionProps) {
  return (
    <SectionBackground
    ...
    >
      <SectionSEO
        title="Book a Free Consultation | Axie Studio"
        description="Let's discuss how our booking system can be customized to streamline your business."
        slug="cta"
        type="Action"
      />
      ...
      <div className="max-w-3xl mx-auto">
        <div className="space-y-8 text-center">
          ...
          >
            Let's discuss how our booking system can be customized to streamline your specific business.
          </motion.p>
