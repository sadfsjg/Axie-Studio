...
import { Calendar, Clock, CreditCard, LayoutGrid, Mail, BarChart, LinkIcon, Bell } from "lucide-react"
...
export function FeaturesSection({ features, onDemoClick }: FeaturesSectionProps) {
  ...
  return (
    <section className="relative py-16 lg:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(59,130,246,0.05)_0%,transparent_50%)] bg-[radial-gradient(circle_at_70%_80%,rgba(139,92,246,0.05)_0%,transparent_50%)]"></div>

      {/* Floating decorative elements */}
      <div className="absolute top-20 left-10 w-20 h-20 bg-blue-200/20 rounded-full blur-xl animate-float"></div>
      <div className="absolute bottom-20 right-10 w-32 h-32 bg-purple-200/20 rounded-full blur-2xl animate-float animation-delay-2000"></div>
      <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-cyan-200/20 rounded-full blur-lg animate-pulse"></div>
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Discover powerful features designed to streamline your booking process and enhance customer experience
            </p>
          </motion.div>
        </div>
...
export { FeaturesSection as FeaturesSectionEn }
