...
export function HeroSectionEn({ onDemoClick, onExploreClick }: HeroSectionEnProps) {
  ...
  const structuredData = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://www.axiestudio.se/en/#hero",
    },
  ...
  return (
    <section
      id="hero"
      className="relative py-6 md:py-12 lg:py-16 xl:py-24 bg-gradient-to-b from-blue-50 to-white overflow-hidden"
    >
      <Script
        id="hero-structured-data-en"
