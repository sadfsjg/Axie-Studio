...
export function MobileAppsSectionNoI18nEn({ onDemoClick }: { onDemoClick?: () => void }) {
  ...
  const sectionTitles = {
    title: "Mobile App",
    appsInPractice: "See in Reality",
    customerBenefits: "What to Expect?",
    businessBenefits: "What You Get!",
    searchVisible: "Visible in Google searches",
    appInSearchResults: "Your Website is Searchable",
  }
  ...
  return (
    <SectionBackground id="mobile-apps" ref={containerRef} className="bg-gradient-to-b from-white to-slate-50">
      <motion.div initial="hidden" animate={controls} variants={titleVariants} className="text-center mb-12 md:mb-16">
        ...
        >
          <div className="mb-8">
            <motion.h3
              ...
              className="text-2xl font-bold text-slate-800 mb-4 md:mb-6"
            >
              {sectionTitles.appsInPractice}
            </motion.h3>
            <p className="text-slate-600 mb-6">Click on the logos below to see how different salons use our apps:</p>

            <div ref={scrollContainerRef} className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8 overflow-x-auto pb-4">
              {salonApps.map((app) => (
                <button
                  key={app.id}
          ...
          <div className="mb-8">
            ...
            >
              {sectionTitles.customerBenefits}
            </motion.h3>
          ...
          <div className="mb-8">
            <motion.h3
              ...
              className="text-2xl font-bold text-slate-800 mb-4"
            >
              {sectionTitles.businessBenefits}
            </motion.h3>
      ...
      >
        <div className="inline-block bg-blue-50 rounded-full px-4 py-1.5 text-sm text-blue-700 font-medium mb-4 border border-blue-100">
          <Search className="inline-block h-4 w-4 mr-1 -mt-0.5" /> {sectionTitles.searchVisible}
        </div>
        <motion.h3
          initial="hidden"
          animate={controls}
          ...
          className="text-2xl font-bold text-slate-800 mb-4"
        >
          {sectionTitles.appInSearchResults}
        </motion.h3>
