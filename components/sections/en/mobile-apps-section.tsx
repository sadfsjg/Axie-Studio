...
export function MobileAppsSectionEn({ onDemoClick }: { onDemoClick?: () => void }) {
  ...
  const salonApps = [
    {
      ...
      description: "Professional hair salon focusing on quality and customer service.",
    },
    {
      id: "viking",
      name: "Viking Salon",
      ...
      description: "Modern men's salon with traditional values and expertise.",
    },
    {
      id: "torget",
      name: "Torget's Barbershop",
      logo: "/images/torgets-logo.jpeg",
      url: "https://torgetsbarbershop.axiestudio.se/",
      description: "Classic barbershop focusing on beard care and men's haircuts.",
    },
    {
      id: "bellavida",
      ...
      description: "Exclusive barbershop with personal service and relaxed atmosphere.",
    },
  ]
  ...
  const customerBenefits = [
    {
      title: "Book directly from your home screen",
      description:
        "Customers can easily book appointments directly from their home screen without having to search the web.",
    },
    {
      title: "Get reminders about your booking",
      description: "Automatic reminders reduce the risk of missed appointments and improve the customer experience.",
    },
    {
      title: "Easy to cancel or reschedule",
      description: "Customers can easily manage their bookings at any time, providing increased flexibility.",
    },
    {
      title: "Works even without internet connection",
      description: "PWA technology allows the app to work even with limited or no internet connection.",
    },
  ]
  ...
  const businessBenefits = [
    {
      ...
      title: "Visible in search results",
      description: "Your app appears directly when customers search for you online",
      bgColor: "bg-blue-100",
    },
    {
      icon: <Award className="h-5 w-5 text-green-600" />,
      title: "Increased conversion",
      description: "Up to 300% higher booking frequency",
      bgColor: "bg-green-100",
    },
    {
      icon: <Bell className="h-5 w-5 text-amber-600" />,
      title: "Reduced cancellations",
      description: "Automatic reminders reduce missed visits",
      bgColor: "bg-amber-100",
    },
    {
      icon: <Smartphone className="h-5 w-5 text-purple-600" />,
      title: "Improved customer experience",
      description: "Smooth booking increases customer loyalty",
  ...
  return (
    <SectionBackground id="mobile-apps" ref={containerRef} className="bg-gradient-to-b from-white to-slate-50">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">Mobile Apps for Your Customers</h2>
        <p className="text-xl text-slate-600 max-w-3xl mx-auto">
          Let your customers easily book appointments directly from their home screen for higher conversion and
          accessibility
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        >
          <div className="relative mx-auto max-w-[320px]">
              ...
              <div className="relative pt-7 bg-white">
                ...
                <div className="h-[580px] overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4 text-white">
                    ...
                    <p className="text-center text-xs text-blue-100">Book online</p>
                  </div>

                  {/* App body */}
                  <div className="p-4">
                    <div className="mb-4">
                      <h4 className="text-sm font-medium text-gray-700 mb-2">Select service</h4>
                      <div className="bg-white border border-gray-200 rounded-lg p-3 flex justify-between items-center shadow-sm">
                        <span className="text-sm font-medium">Men's Haircut - $35</span>
            ...
            <div className="absolute -top-16 right-0 bg-white rounded-lg p-3 shadow-lg max-w-[200px] border border-gray-200">
              <div className="text-sm font-medium">Add to home screen for easy access!</div>
        ...
        >
          <div className="mb-8">
            <h3 className="text-2xl font-bold text-slate-800 mb-6">Our Customer Apps in Practice</h3>
            <p className="text-slate-600 mb-6">Click on the logos below to see how different salons use our apps:</p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
              {salonApps.map((app) => (
                ...
                >
                  <div className="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center rounded-full bg-white shadow-md mb-2 overflow-hidden">
                    <Image
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-bold text-slate-800 mb-4">Benefits for Your Customers</h3>
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-bold text-slate-800 mb-4">Benefits for Your Business</h3>
          ...
          <div className="text-center">
            <a
              ...
              className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-blue-600 hover:bg-blue-700 text-white h-11 px-8 py-6"
            >
              See demo of {activeApp.name}
              <ArrowRight className="ml-2 h-5 w-5" />
            </a>
            <p className="text-sm text-slate-500 mt-2">Works on all devices - iPhone, Android, and computers</p>
          </div>
        </motion.div>
      </div>
      ...
      >
        <div className="inline-block bg-blue-50 rounded-full px-4 py-1.5 text-sm text-blue-700 font-medium mb-4 border border-blue-100">
          <Search className="inline-block h-4 w-4 mr-1 -mt-0.5" /> Visible in Google searches
        </div>
        <h3 className="text-2xl font-bold text-slate-800 mb-4">Your app appears directly in search results</h3>
        <p className="text-slate-600 max-w-2xl mx-auto mb-8">
          When customers search for your salon online, they easily find your app and can book directly - without having
          to download anything from the App Store or Google Play.
        </p>

        <div className="bg-white rounded-xl p-6 max-w-3xl mx-auto border border-slate-200 shadow-md">
          ...
          <div className="bg-slate-50 rounded-lg p-4 mb-3 border border-slate-200">
            <div className="flex items-center">
              ...
              <div>
                <h4 className="text-slate-800 font-medium">{activeApp.name} - Book Online</h4>
                <p className="text-slate-500 text-sm">{activeApp.url}</p>
              </div>
            </div>
            <p className="text-slate-600 text-sm mt-2">
              {activeApp.description} Book appointments online directly from our app without having to call.
            </p>
          </div>
