...
interface HeroSectionNoI18nProps {
  onDemoClick?: () => void
  onExploreClick?: () => void
}

export function HeroSectionNoI18n({ onDemoClick, onExploreClick }: HeroSectionNoI18nProps) {
  ...
  const structuredData = {
    ...
    headline: "Bokningssystem som förenklar din vardag",
    description:
    ...
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/axie-studio-logo.png-NuqchLn54kB9iWfTXSPNMBColqGIom.jpeg",
  }

  return (
    <section
      id="hero"
      className="relative pt-28 md:pt-32 lg:pt-36 pb-6 md:pb-12 lg:pb-16 xl:pb-24 bg-gradient-to-b from-blue-50 to-white overflow-hidden"
    >
      <Script
      ...
      <div className="container mx-auto px-4">
        <div className="grid gap-6 lg:grid-cols-[1fr_500px] lg:gap-16 xl:grid-cols-[1fr_600px] 2xl:grid-cols-[1fr_700px] items-center max-w-screen-2xl mx-auto">
          <div className="flex flex-col justify-center space-y-4 md:space-y-8">
            <div className="space-y-3 md:space-y-6">
              ...
              >
                ...
                <span>Framtidens bokningssystem</span>
              </motion.div>

              <AnimatedText
                as="h1"
                text="Bokningssystem som förenklar din vardag"
              ...
              >
                Effektivisera din verksamhet med vårt skräddarsydda bokningssystem. Spara tid, öka kundnöjdheten och få
                full kontroll över din kalender.
              </motion.p>
            </div>
            ...
            >
              ...
              >
                <span className="text-base">Utforska funktioner</span>
              </Button>
            </motion.div>
          </div>
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="absolute bottom-2 md:bottom-4 lg:bottom-6 xl:bottom-10 left-0 right-0 flex flex-col items-center justify-center animate-bounce optimize-gpu"
      >
        <span className="text-sm text-slate-600 mb-2">Scrolla ner</span>
        <motion.div
          animate={{ y: [0, 10, 0] }}
