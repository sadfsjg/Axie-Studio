...
export function HeroSection({ onDemoClick, onExploreClick }: HeroSectionProps) {
          ...
          <div className="flex flex-col justify-center space-y-4 md:space-y-8">
            <div className="space-y-3 md:space-y-6">
              ...
              >
                ...
                <span>{t("hero.futureBooking")}</span>
              </motion.div>
            ...
            >
              ...
              >
                <span className="text-base">{t("common.exploreFeatures")}</span>
              </Button>
            </motion.div>
          </div>
