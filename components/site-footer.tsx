  ...
  return (
    <footer className="bg-gradient-to-b from-slate-50 to-slate-100 border-t border-slate-200">
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        >
          ...
          <motion.div variants={itemAnimation} className="space-y-4">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Specialister inom integrerade admin & client bokningssystem och automatisering. Vi erbjuder också moderna,
              hemsidor för en komplett lösning.
            </p>
          ...
          {/* Services */}
          <motion.div variants={itemAnimation} className="space-y-4">
            <h3 className="text-lg font-bold text-slate-900 border-b border-slate-200 pb-2">Tjänster</h3>
          ...
          {/* Contact */}
          <motion.div variants={itemAnimation} className="space-y-4">
            <h3 className="text-lg font-bold text-slate-900 border-b border-slate-200 pb-2">Kontakt</h3>
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-slate-600">Jönköping, Sverige</span>
              </li>
            </ul>
          </motion.div>
          ...
          {/* Quick Links */}
          <motion.div variants={itemAnimation} className="space-y-4">
            <h3 className="text-lg font-bold text-slate-900 border-b border-slate-200 pb-2">Snabblänkar</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-slate-600 hover:text-blue-600 transition-colors flex items-center group">
                  <span className="w-1.5 h-1.5 bg-slate-300 rounded-full mr-2 group-hover:bg-blue-500 transition-colors"></span>
                  Hem
                </Link>
              </li>
        ...
        >
          <div className="mb-4 md:mb-0">© {currentYear} Axie Studio. Alla rättigheter förbehållna.</div>
        </motion.div>
      </div>
    </footer>
  )
