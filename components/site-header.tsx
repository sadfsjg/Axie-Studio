  ...
  const navItems = [
    {
      ...
      dropdown: [
        { href: "#booking-features", label: "Bokningsfunktioner" },
        { href: "#admin-features", label: "Adminfunktioner" },
        { href: "#client-features", label: "Klientfunktioner" },
      ],
    },
    { href: "#app-benefits", label: t("nav.appBenefits") },
    { href: "#mobile-apps", label: t("nav.mobileApps") },
